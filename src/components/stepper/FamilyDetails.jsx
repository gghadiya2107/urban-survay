...
export default function FamilyDetails(props) {
  ...
  useEffect(() => {
    ...
    if (tokenData) {
      ...
      console.log(ulb, "asdiuhdkjansdkasd");
      setUlbData(ulb);
    }
    ...
    if (family_data) {
      ...
      console.log(family_data, "ajskdasdqwdasijkwasdh");
    ...
    const getAllMaster = async () => {
      ...
      console.log(callAPi, "Asdbqwuilaknjvhjfwekjsd");

      const res = await callAPi.json();
      console.log(res, "Asdbqwuilaknjvhjfwekjsd");
      ...
      for (let i = 0; i < economicCategories.length; i++) {
        ...
        console.log(value, "sakdjkldfdweas");
      ...
      console.log(resident, "asdhbfsedjkfbdasjkdfs");
      ...
      if (status === "OK" && message === "SUCCESS") {
        for (let i = 0; i < data.length; i++) {
          ...
          if (ulbData.districtCode == data[i].districtCode) {
            ...
            console.log(ulbData.districtCode, "dsabdkqnjwas");
            console.log(data[i].districtCode, "dsabdkqnjwas");
          }
        }
    ...
    if (municipality_reducer?.data) {
      ...
      if (status === "OK" && message === "SUCCESS") {
        for (let i = 0; i < data.length; i++) {
          ...
          console.log(ulbData.municipalId, "asdnjiakdnwiqndaisd");
        ...
        <Button
          ...
          onClick={() => {
            ...
            if (blankKeys.length > 0) {
              ...
              console.log("Object does not contain blank values.", props);
              handleNext();
            }
          }}
